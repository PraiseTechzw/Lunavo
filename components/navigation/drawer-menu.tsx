...
const ROLE_SPECIFIC_ITEMS: Record<string, DrawerItem[]> = {
  ...
  'peer-educator-executive': [
    { id: 'dashboard', label: 'Executive Dashboard', icon: 'dashboard', route: '/peer-educator/executive/dashboard', section: 'role' },
    { id: 'flag-review', label: 'Flag Review', icon: 'flag', route: '/peer-educator/executive/flag-review', section: 'role' },
    { id: 'peer-activity', label: 'Peer Activity', icon: 'people', route: '/peer-educator/executive/peer-activity', section: 'role' },
    { id: 'content-approval', label: 'Content Approval', icon: 'approval', route: '/peer-educator/executive/content-approval', section: 'role' },
    { id: 'reports', label: 'Reports', icon: 'description', route: '/peer-educator/executive/reports', section: 'role' },
    { id: 'members', label: 'Members', icon: 'people-outline', route: '/peer-educator/executive/members', section: 'role' },
    { id: 'analytics', label: 'Analytics', icon: 'analytics', route: '/peer-educator/executive/analytics', section: 'role' },
    { id: 'meetings', label: 'Meetings', icon: 'event', route: '/peer-educator/executive/meetings', section: 'role' },
    { id: 'announcements', label: 'Announcements', icon: 'campaign', route: '/peer-educator/executive/announcements', section: 'role' },
  ],
  moderator: [
