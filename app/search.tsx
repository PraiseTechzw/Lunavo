    ...
    return (
      <View style={styles.recentSearches}>
        ...
        {recentSearches.map((search, index) => (
          <TouchableOpacity
            key={index}
            style={[styles.recentSearchItem, { backgroundColor: colors.surface }]}
    ...
    <SafeAreaView edges={['top']} style={styles.safeArea}>
      <ThemedView style={styles.container}>
        ...
        <View style={[styles.searchContainer, { backgroundColor: colors.background }]}>
          <MaterialIcons name="search" size={24} color={colors.icon} style={styles.searchIcon} />
          <TextInput
        ...
        <View style={[styles.tabsContainer, { backgroundColor: colors.background }]}>
          {(['all', 'posts', 'resources', 'users'] as SearchTab[]).map((tab) => (
            <TouchableOpacity
              key={tab}
              style={[
                styles.tab,
        ...
        {loading ? (
          ...
          <FlatList
            ...
            ListHeaderComponent={
              <ThemedText type="body" style={[styles.resultsCount, { color: colors.icon }]}>
