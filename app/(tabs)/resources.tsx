            ...
            >
              <View style={styles.featuredContent}>
                ...
                <ThemedText style={styles.featuredTitle}>
                  Mental Health Wellness Guide 2024
                </ThemedText>
                <ThemedText style={styles.featuredSubtitle}>
                  Essential tips for managing exam stress and burnout.
                </ThemedText>
                <TouchableOpacity 
                  style={styles.readButton}
                  onPress={() => router.push("/resource/list")}
                >
                  <ThemedText style={styles.readButtonText}>Open Library</ThemedText>
        ...
        <View style={styles.categoryGrid}>
          {CATEGORIES.map((cat) => (
            ...
            >
              ...
              <ThemedText style={styles.catCount}>{cat.count}</ThemedText>
            </TouchableOpacity>
          ))}
        </View>
